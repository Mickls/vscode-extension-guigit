...
export declare const allRpcRequestTypes: readonly ["history.load", "branches.list", "commits.getDetails", "files.getChanges", "files.openWorkingFile", "files.openHistory", "graph.getLayout", "diff.openCommitFile", "diff.openCompareFile", "remotes.list", "remotes.add", "remotes.update", "remotes.delete", "settings.get", "settings.update", "git.pull", "git.advancedPull", "git.push", "git.advancedPush", "git.fetch", "git.clone", "git.checkout", "git.cherryPick", "git.revert", "git.reset", "git.compareCommits", "git.squashCommits", "git.createBranchFromCommit", "git.pushAllCommitsToHere", "git.editCommitMessage"];
export declare const backendRpcHandlerTypes: readonly ["history.load", "branches.list", "commits.getDetails", "files.getChanges", "files.openWorkingFile", "files.openHistory", "graph.getLayout", "diff.openCommitFile", "diff.openCompareFile", "remotes.list", "remotes.add", "remotes.update", "remotes.delete", "settings.get", "settings.update", "git.pull", "git.advancedPull", "git.push", "git.advancedPush", "git.fetch", "git.clone", "git.checkout", "git.cherryPick", "git.revert", "git.reset", "git.compareCommits", "git.squashCommits", "git.createBranchFromCommit", "git.pushAllCommitsToHere", "git.editCommitMessage"];
